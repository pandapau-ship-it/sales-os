...
- [~] **Companies-Detailseite (K-4b, in Arbeit)** — volle Seite `ScreenCompanyDetail`: Kopf + KPIs bereits echt (K-4a); Tabs Übersicht/Kontakte/Deals/Aktivität/Notizen + Bearbeiten/Anlegen folgen. *(Companies ist jetzt eigenständiger Nav-Screen mit Sidebar-Icon — ersetzt die alte „Companies: kein Nav-Punkt"-Zeile unten.)*
