...
- [ ] **[D-voice-altfelder-cleanup]** alte DB-Keys `sentence_style`/`hooks`/`themes` entfernen — **erst NACH** Daten-Neueingabe (PROGRESS deferred). Jetzt bewusst als Sicherheitsnetz behalten.
- [ ] **Daten-Neueingabe** der getrennten Voice-Inhalte (Chat-Claude, Schreibweg `update_voice_profile`) — nach Screenshot-QA + Merge.
