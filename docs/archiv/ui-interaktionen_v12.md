...
# Version 12 · Juni 2026 — Zusammenführung v2 + v3 + v8 + v9
...
Horizontaler Funnel über die **kanonischen Stages** (frei konfigurierbar pro Organization
aus settings/pipeline_stages — nie hardcodiert; Liste unten ist nur der Default):
...
Darunter: Conversion-Rates pro Stage-Übergang (dynamisch aus den konfigurierten Stages)
(„Verloren" ist terminaler Status, erscheint nicht im Funnel-Flow.)
...
## 28. EMAIL-VERIFIZIERUNG — UI-INDIKATOREN

### Onboarding / Erste Mailbox verbinden
- Aktiver Hinweis: "Möchtest du Email-Verifizierung aktivieren? Schützt deine Mailbox-Reputation." + "Jetzt aktivieren"
- Nicht überspringbar — User muss aktiv JA/NEIN wählen

### Kontakte-Liste + Side Panel — Icon neben Email
- Verifiziert: grünes Haken-Icon ✓
- Nicht verifiziert: graues Fragezeichen
- Invalid: rotes X + Tooltip "Email ungültig"
- Catch-All: amber ~ + Tooltip "Verifizierung nicht möglich"
- Nicht geprüft: kein Icon

### Side Panel Kontaktdetails
- Email-Zeile: "thomas@firma.de ✓" (Haken direkt hinter Email)
- Klick auf Icon: Tooltip "Verifiziert am [Datum] via ZeroBounce"
- Bei ungültig: "Erneut verifizieren" Link

### Import-Dialog
- Fortschrittsbalken während Verifikation
...
*Sales OS · Sherloq · Juni 2026 · Version 12*
