...
export default function TaskDrawer({
  ...
  return (
    <div className="fixed inset-0 bg-[var(--text-body)]/20 backdrop-blur-sm z-50 flex justify-end font-sans transition-opacity animate-fade-in pr-2 py-2" onClick={onClose}>
      <div
        className="w-full max-w-[850px] h-full bg-[var(--app-bg)] shadow-2xl flex flex-col relative overflow-hidden animate-slide-left rounded-3xl border border-[var(--border)]"
