...
export default function KpiCard({
  ...
  return (
    <div className="bg-app-surface rounded-[12px] p-6 border border-[var(--border-card)] shadow-[var(--shadow-card)] flex flex-col justify-between h-[160px] hover:shadow-[var(--shadow-hover)] transition-shadow relative">
