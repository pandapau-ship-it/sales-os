        ...
        {open.map((task) => {
          ...
          return (
            <div
              ...
              onClick={onOpenTasks}
              className={`group p-4 rounded-[12px] flex items-center justify-between gap-3 cursor-pointer transition-all ${due_now ? "bg-[var(--signal-warn-bg)] border border-[var(--signal-warn-bg)]" : "bg-app-surface border border-[var(--border-card)] hover:bg-app-bg"}`}
            >
