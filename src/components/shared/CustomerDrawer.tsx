          ...
          <div className="p-8 pb-12 w-full mx-auto flex flex-col gap-6">
            ...
            <div ref={commSectionRef} className="bg-app-surface border border-border rounded-[14px] p-6 shadow-card w-full mt-2">
              ...
              <div className="flex flex-col gap-6">
                {/* Item 1 */}
                <div className="flex flex-col border-b border-[#F1F3F5] pb-6 last:border-0 last:pb-0">
                  <div
                  ...
                  >
                    ...
                    <div className="flex flex-col flex-1 pr-2">
                      ...
                      <div className="flex items-center gap-1.5 text-[#ADB5BD] text-[11px] font-medium mt-2">
                        {expandedComm[1] ? (
