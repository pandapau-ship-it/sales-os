  ...
  const leads = [
    {
      ...
      score: 92, stage: "Demo", heat: "Engaged", heatColor: "bg-[var(--signal-success-bg)] text-[var(--color-success)] border-[var(--signal-success-bg)]",
    ...
    },
    {
      ...
      score: 68, stage: "Discovery", heat: "Warm", heatColor: "bg-[var(--signal-warn-bg)] text-[var(--color-warning-soft)] border-[var(--signal-warn-bg)]",
    ...
    },
    {
      ...
      score: 45, stage: "Proposal", heat: "Cold", heatColor: "bg-[var(--signal-info-bg)] text-[var(--color-info)] border-[var(--signal-info-bg)]",
