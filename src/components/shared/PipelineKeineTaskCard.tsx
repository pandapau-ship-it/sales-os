...
>
  ...
  <div className="p-[20px] flex items-center justify-between gap-6 flex-wrap">
    ...
    <div className="flex items-center gap-4 flex-1 min-w-0">
      <div className="relative shrink-0">
        <div className="w-10 h-10 rounded-full bg-[#D97706] text-white flex items-center justify-center text-[13px] font-bold shadow-[0_2px_6px_rgba(0,0,0,0.1)]">
          SJ
        </div>
        <div className="absolute -bottom-[2px] -right-[2px] w-[14px] h-[14px] bg-[#F59E0B] border-2 border-white rounded-full"></div>
      </div>
    ...
    <div className="flex items-center gap-5 px-5 border-l border-[#F1F3F5] shrink-0">
      <div className="relative w-12 h-12">
        ...
        <span className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-[13px] font-bold text-[#F59E0B] tracking-tighter font-mono">
          65
        </span>
      </div>
    ...
    <div className="flex items-center gap-4 px-5 border-l border-[#F1F3F5] shrink-0">
      ...
      <div className="flex flex-col items-center relative w-[100px]">
        ...
        <div className="px-4 py-1.5 rounded-full bg-[#FFF9DB] border border-[#FFF9DB] text-[12px] font-semibold text-[#D97706] flex items-center gap-1.5">
    ...
    <div className="flex items-center gap-5 pl-5 border-l border-[#F1F3F5] shrink-0">
      <div className="text-right">
        ...
        <div className="text-[12px] text-[#868E96] font-semibold mt-[2px] whitespace-nowrap">
          Neu in Pipeline
        </div>
      </div>
  ...
  <div className="bg-[#F8F9FA] border-t border-[#E9ECEF] px-8 py-2.5 flex items-center justify-between gap-4 flex-wrap">
    <div className="flex items-center gap-3 shrink-0">
      <div className="bg-[#FFE8CC] text-[#D97706] px-3 py-1.5 rounded-[8px] flex items-center gap-2 text-[14px] font-bold">
        <svg
          width="16"
          height="16"
          viewBox="0 0 24 24"
