// MIRROR von src/lib/filter/compile.ts — Deno-Edge kann src/ nicht importieren (Präzedenz terminalStages.ts).
...
import { getFieldSpec } from "./schema.ts";
import { validateFilter } from "./validate.ts";
import type { FilterEntity } from "./types.ts";
